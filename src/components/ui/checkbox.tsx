...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      <Check className="h-4 w-4" /> {/* Kept inner check slightly smaller for better visual */}
    </CheckboxPrimitive.Indicator>
  </CheckboxPrimitive.Root>
))
